...
+ (instancetype)utils_colorWithHex:(uint32_t)hex {
    ...
    return [self utils_colorWithRed:r green:g blue:b];
}

+ (instancetype)utils_randomColor {
    return [UIColor utils_colorWithRed:arc4random_uniform(256) green:arc4random_uniform(256) blue:arc4random_uniform(256)];
}
