...
- (NSString *)dateString: (NSString *)dateFormat {
    ...
    NSString *convertedString = [formatter stringFromDate:self];
    
    return convertedString;
}

+(NSDate *)dateFromLongMs :(NSString *) longMsString {
    ...
    NSNumber *longms = [NSNumber numberWithLongLong:longMsString.longLongValue];
    
    NSTimeInterval longSeconds = longms.longLongValue/1000;
...
//return string format in "yyyy-mm-dd hh:mm:ss"
-(NSString *)timeStringJava {
...
+(NSNumber *) dateToTicks:(NSDate *) date
{
...
+(NSNumber *) dateToMilliSec:(NSDate *)date {
    NSTimeInterval seconds = [date timeIntervalSince1970];
    double milliseconds = seconds*1000;
    NSNumber *nsNumber = [NSNumber numberWithDouble:milliseconds];
